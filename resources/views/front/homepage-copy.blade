    ...
    <section class="why-blockchain">
        <div class="container">
            <div class="section-title" data-aos="fade-up">
                ...
                <p>Công nghệ Blockchain mang đến một kỷ nguyên mới cho sự minh bạch, đảm bảo mỗi thông tin về sản phẩm đều
            ...
            <div class="row g-4">
                <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="100">
                    <div class="feature-box">
                        ...
                        <p>Toàn bộ nhật ký từ trồng trọt, thu hoạch đến chế biến đều được công khai và dễ dàng truy cập.</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="200">
                    <div class="feature-box">
                        ...
                        <p>Một khi thông tin đã được ghi vào chuỗi khối (blockchain), không ai có thể sửa đổi hay xóa bỏ.
                        </p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="300">
                    <div class="feature-box">
                        ...
                        <p>Người tiêu dùng có thể tự mình kiểm chứng nguồn gốc, chất lượng sản phẩm chỉ với một mã QR.</p>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6" data-aos="fade-up" data-aos-delay="400">
                    <div class="feature-box">
                        ...
                        <p>Sự minh bạch giúp khẳng định giá trị thương hiệu chè Thái Nguyên trên thị trường trong và ngoài
                            nước.</p>
                    </div>
                </div>
            </div>
    ...
    <section class="process-section">
        <div class="container">
            <div class="section-title" data-aos="fade-down">
                ...
                <p>Theo dõi từng bước đi của sản phẩm, từ những đồi chè xanh mướt tại Thái Nguyên cho đến khi trở thành ấm
            ...
            <div class="timeline">
                <div class="timeline-container left" data-aos="fade-right">
                    <div class="timeline-content">
                        ...
                        <div>
                            ...
                            <p>Nhật ký về giống chè, quy trình chăm sóc hữu cơ, sử dụng phân bón, nguồn nước được ghi lại.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="timeline-container left" data-aos="fade-right">
                    <div class="timeline-content">
                        ...
                        <div>
                            <h3>3. Chế Biến</h3>
                            <p>Các công đoạn sao, vò, sấy chè tại nhà máy, cùng với tiêu chuẩn chất lượng được lưu trữ.</p>
                        </div>
                    </div>
                </div>
                <div class="timeline-container right" data-aos="fade-left">
                    <div class="timeline-content">
                        ...
                        <div>
                            ...
                            <p>Sản phẩm được đóng gói, dán nhãn QR độc nhất. Thông tin lô, ngày sản xuất được cập nhật.</p>
                        </div>
                    </div>
                </div>
                <div class="timeline-container left" data-aos="fade-right">
                    <div class="timeline-content">
                        ...
                        <div>
                            <h3>5. Đến Tay Bạn</h3>
                            <p>Quét mã QR trên bao bì để xem toàn bộ hành trình minh bạch của sản phẩm mà bạn đang cầm trên
                                tay.</p>
                        </div>
                    </div>
                </div>
