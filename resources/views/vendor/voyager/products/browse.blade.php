                                    ...
                                    @foreach ($dataTypeContent as $data)
                                        <tr>
                                            ...
                                            <td class="no-sort no-click bread-actions">
                                                @foreach ($actions as $action)
                                                    @if (!method_exists($action, 'massAction'))
                                                        @include('voyager::products.partials.actions', [
                                                            'action' => $action,
                                                        ])
                                                    @endif
                                                @endforeach
                                                <a href="{{ route('products.add-stages', $data->id) }}"
                                                    class="btn btn-sm btn-success pull-right add-stage" title="Ghi nhật ký">
                                                    <i class="voyager-edit"></i><span class="hidden-xs hidden-sm"> Ghi nhật
                                                        ký</span>
                                                </a>
                                            </td>
                                        </tr>
